function [] = disp_accuracy_mod_confdata()

clc;
clear;

%% change the settings here
savepaths{1} = ['/lusr/u/ayan/MLDisk/confdata_15_Dec_2012/'];

otherindex = 'big_run3';
classfilenameprefix = '/lusr/u/ayan/Documents/DSLDA_SDM/DSLDA/conferencenames';
p1mat = [0.6];
p2mat = p1mat;
p3mat = [0.1:0.1:1];
k2mat = [100];
epsilonmat = [0.4:0.1:0.9];
classnum = 6;
option = 4;
troption = 0;
svmoptionval = 4;
...
dirname = '/lusr/u/ayan/MLDisk/confdata_results/big_run3/';
