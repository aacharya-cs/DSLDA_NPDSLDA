function [] =  compile_mcc_confdata (MAXCOUNTmat, MaxFunmat, MAXESTEPITERmat, MAXMSTEPITERmat, filename, p1mat, p2mat, p3mat, k2mat, option, troption, numexp, svmoptionval, svmcval, minvtopic, pathname, otherindex, iternum, epsilonmat)

%% for compiling matlab code with mcc..
%% @ Ayan Acharya, Date: Dec 15, 2012..

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%% compile_mcc_confdata ([3], [3], [3], [3], 'conferencenames.txt', [0.2], [0.2], [0.8], [100], 4, 0, 6, 4, 10, 4, '/lusr/u/ayan/Documents/DSLDA_SDM/forconfdata/', 'trial_run_confdata', 1, 0.8);
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
if (strcmp('GLNXA64', computer()))
    mcc -m /v/filer4b/v35q001/ayan/Documents/DSLDA_SDM/DSLDA/mainfile_confdata.m...
                            ...
                            for arg8 = 1:iternum
                                for arg9 = 1:length(epsilonmat)
                                    for i=1:numexp
                                        ...
                                        writescript_confdata(params);
                                    end
                                    condorscript = ['./condorsubmit_confdata.sh ' num2str(numexp) ' mainfile_confdata'];
                                    system(condorscript);
                                end
                            end
                        end
