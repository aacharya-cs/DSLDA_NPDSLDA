...
numjobs = 1;
scriptname = ['/lusr/u/ayan/MLDisk/DSLDA_mccfiles/run_mainfile_confdata' num2str(i) '.sh'];
...
fprintf(fp, 'executable = /lusr/u/ayan/Documents/DSLDA_SDM/mccfiles/mainfile_confdata\n');
...
outfile = ['output = /lusr/u/ayan/MLDisk/DSLDA_mccfiles/condor_log_confdata/mainfile_confdata' num2str(i) otherindex '.out'];
fprintf(fp, '%s\n', outfile);
err = ['error = /lusr/u/ayan/MLDisk/DSLDA_mccfiles/condor_log_confdata/mainfile_confdata' num2str(i) otherindex '.err'];
fprintf(fp, '%s\n', err);
