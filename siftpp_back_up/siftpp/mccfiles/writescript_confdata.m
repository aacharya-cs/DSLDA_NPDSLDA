function [] = writescript_confdata (params)
...
numjobs = 1;
scriptname = ['/v/filer4b/v35q001/ayan/Documents/DSLDA_SDM/mccfiles/run_mainfile_confdata' num2str(i) '.sh'];
...
fprintf(fp, 'executable = /v/filer4b/v35q001/ayan/Documents/DSLDA_SDM/mccfiles/mainfile_confdata\n');
...
arg17 = num2str(i);
arg18 = num2str(iter);
arg19 = num2str(epsilon);

arg = ['arguments = ' arg1 ' ' arg2 ' ' arg3 ' ' arg4 ' ' arg5];
arg = [arg ' ' arg6 ' ' arg7 ' ' arg8 ' ' arg9 ' ' arg10 ' ' arg11 ' ' arg12 ' ' arg13 ' ' arg14];
arg = [arg ' ' arg15 ' ' arg16 ' ' arg17 ' ' arg18 ' ' arg19];

fprintf(fp, '%s\n', arg);

outfile = ['output = /v/filer4b/v35q001/ayan/Documents/DSLDA_SDM/mccfiles/condor_log/mainfile_confdata' num2str(i) otherindex '.out'];
fprintf(fp, '%s\n', outfile);
err = ['error = /v/filer4b/v35q001/ayan/Documents/DSLDA_SDM/mccfiles/condor_log/mainfile_confdata' num2str(i) otherindex '.err'];
fprintf(fp, '%s\n', err);
