function [] = writescript (MAXCOUNT, MaxFun, MAXESTEPITER, MAXMSTEPITER, classfilename, p1, p2, k2, option, troption, svmoptionval, svmcval, pathname, otherindex, i) 

numjobs = 1;
scriptname = ['/v/filer4b/v35q001/ayan/Documents/aaaa/mccfiles/run_mainfile_ayahoo' num2str(i) '.sh'];
...
fprintf(fp, 'executable = /v/filer4b/v35q001/ayan/Documents/aaaa/mccfiles/mainfile_ayahoo\n');
...
outfile = ['output = /v/filer4b/v35q001/ayan/Documents/aaaa/mccfiles/condor_log/mainfile_ayahoo' num2str(i) otherindex '.out'];
fprintf(fp, '%s\n', outfile);
err = ['error = /v/filer4b/v35q001/ayan/Documents/aaaa/mccfiles/condor_log/mainfile_ayahoo' num2str(i) otherindex '.err'];
fprintf(fp, '%s\n', err);
