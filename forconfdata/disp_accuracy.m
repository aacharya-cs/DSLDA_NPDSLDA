...
savepaths{1} = ['/v/filer4b/v16q001/ml/data/Ayans/confdata_17_May_2012/'];
savepaths{2} = ['/v/filer4b/v16q001/ml/data/Ayans/confdata_18_May_2012/'];
savepaths{3} = ['/v/filer4b/v16q001/ml/data/Ayans/confdata_19_May_2012/'];
savepaths{4} = ['/v/filer4b/v16q001/ml/data/Ayans/confdata_20_May_2012/'];
savepaths{5} = ['/v/filer4b/v16q001/ml/data/Ayans/confdata_24_May_2012/'];
savepaths{6} = ['/v/filer4b/v16q001/ml/data/Ayans/confdata_25_May_2012/'];
...
p2mat = [0.1:0.1:1];
k2mat = [20:20:200];
prefixfilename = '/lusr/u/ayan/Documents/aaaa/myLDA/May25Results1/';
otherindex = 'newbigrun1';
minvtopic = 1;
