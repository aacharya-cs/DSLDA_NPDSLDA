...
class model(Structure):
	_names = ["param", "nr_class", "nr_feature", "w", "label", "bias", "alpha"]
	_types = [parameter, c_int, c_int, POINTER(c_double), POINTER(c_int), c_double, POINTER(c_double)]
	_fields_ = genFields(_names, _types)
	...
	def get_w(self):
		print "w called"
                liblinear.get_w(self)

	def get_alpha(self):
		print "alpha called"
                liblinear.get_alpha(self)
