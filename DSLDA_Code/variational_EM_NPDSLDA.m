function [model, perfval] = variational_EM_NPDSLDA (data, MAXCOUNT, MAXESTEPITER, MAXMSTEPITER, MaxFun,  p, K1, T, option, epsilon, svmcval)
...
[model, data] = init_params_NPDSLDA(data, K1, T, option, svmcval, epsilon);
countVEM = 1;
maxvalue = -1e50;
